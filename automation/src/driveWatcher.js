...
async function uploadInstructions(auth, folderId, employeeName) {
  ...
  const content = [
    ...
    ``,
    `8. Employer 1 — Most Recent Employer (submit any ONE of the following within 30–60 days):`,
    `   • Relieving-cum-Experience Letter  OR  Relieving + Experience Letter (separate)`,
    `   • Full & Final Settlement Letter  OR  Last Month's Payslip`,
    `   → Upload into the "Employer_1" folder`,
    `   → Name the file with "employer1"  e.g. employer1_relieving_john.pdf`,
    `   → MANDATORY if previously employed`,
    ``,
    ...
    ``,
    `10. Last Payslip (only if previously employed and not submitted under Employer folders)`,
    `   → Upload into the "Payslip" folder`,
    `   → Name the file with "payslip"  e.g. payslip_john.pdf`,
    `   → Will be automatically marked as N/A after 3 days if not applicable`,
    ``,
    `11. Passport (if available)`,
    ...
    ``,
    `12. UAN (Universal Account Number) — via UMANG app`,
    ...
    ``,
    `13. Employer 2 — Previous Employer (mandatory depending on total years of experience):`,
    `   • Relieving-cum-Experience Letter  OR  Relieving + Experience Letter (separate)`,
    `   • Full & Final Settlement Letter  OR  Last Month's Payslip`,
    `   → Upload into the "Employer_2" folder`,
    `   → Name the file with "employer2"  e.g. employer2_relieving_john.pdf`,
    ``,
    `14. Employer 3 — Previous Employer (mandatory depending on total years of experience):`,
    `   • Relieving-cum-Experience Letter  OR  Relieving + Experience Letter (separate)`,
    `   • Full & Final Settlement Letter  OR  Last Month's Payslip`,
    `   → Upload into the "Employer_3" folder`,
    `   → Name the file with "employer3"  e.g. employer3_relieving_john.pdf`,
    ``,
    `TIPS:`,
    `──────`,
