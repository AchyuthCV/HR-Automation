...
async function uploadInstructions(auth, folderId, employeeName) {
  ...
  const content = [
    ...
    `────────────────────────────────────────────────`,
    `8. Post Graduation Consolidated Marksheet and Degree Certificate (Masters / MBA / MTech / PhD)`,
    ...
    ``,
    `9. Last Payslip (only if previously employed)`,
    `   → Upload into the "Payslip" folder`,
    `   → Name the file with "payslip"  e.g. payslip_john.pdf`,
    `   → Will be automatically marked as N/A after 3 days if not applicable`,
    ``,
    `10. Relieving Letter from previous employer (only if previously employed)`,
    `   → Upload into the "Relieving_Letter" folder`,
    `   → Name the file with "relieving"  e.g. relieving_john.pdf`,
    `   → Will be automatically marked as N/A after 3 days if not applicable`,
    ``,
    `TIPS:`,
    `──────`,
